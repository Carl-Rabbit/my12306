...
filepath = "train_code_no.txt"


sqlSentence3 = "create table train_code_no (train_code varchar(20),train_no varchar(20))"
try:
...
for i in range(0, length-1):
    ...
    try:
        sqlSentence4 = "insert into train_code_no (train_code,train_no) values ('%s','%s')" % record
        print(sqlSentence4)
